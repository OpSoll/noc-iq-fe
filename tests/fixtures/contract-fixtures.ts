...
export const AUTH_FIXTURES: ContractFixture<{
  id: string;
  email: string;
  role: string;
}> = {
...
export const AUDIT_FIXTURES: ContractFixture<
  Array<{ action: string; timestamp: string; user: string }>
> = {
  version: '1.0',
  label: 'audit-trail',
  capturedAt: '2026-06-20T12:00:00Z',
