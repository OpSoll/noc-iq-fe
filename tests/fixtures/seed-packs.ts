...
export const PACK_NORMAL: SeedPack = {
  ...
  webhooks: [
    {
      id: 'wh-1',
      url: 'https://hooks.example.com/normal',
...
export const PACK_DEGRADED: SeedPack = {
  ...
  outages: [
    {
      id: 'out-1',
      site_name: 'Lagos Node 2',
      site_id: 'NG-LA-02',
      severity: 'medium',
      status: 'open',
      detected_at: '2026-06-23T08:30:00Z',
      description: 'Intermittent packet loss on backbone link',
    ...
    },
    {
      ...
      severity: 'low',
      status: 'open',
      detected_at: '2026-06-23T10:15:00Z',
      description: 'Minor latency spike on CDN egress',
      affected_services: ['CDN'],
      affected_subscribers: 450,
    },
  ],
  webhooks: [
    {
      id: 'wh-2',
      url: 'https://hooks.example.com/degraded',
...
export const PACK_INCIDENT_HEAVY: SeedPack = {
  name: 'incident-heavy',
  description:
    'Multiple critical outages with SLA violations and payment history',
  outages: [
    {
      id: 'out-10',
      ...
      severity: 'critical',
      status: 'open',
      detected_at: '2026-06-22T14:00:00Z',
      description: 'Total upstream provider failure — all traffic affected',
      affected_services: ['DNS', 'VoIP', 'CDN', 'BGP'],
      affected_subscribers: 15000,
      assigned_to: 'senior-ops',
    },
    {
      id: 'out-11',
      ...
      resolved_at: '2026-06-21T08:45:00Z',
      description: 'Fiber cut on primary trunk',
      affected_services: ['BGP', 'VoIP'],
      affected_subscribers: 8000,
      root_cause: 'Third-party construction damage',
      resolution_notes: 'Failover to secondary link activated',
    },
    {
      id: 'out-12',
      site_name: 'Cairo Edge',
      site_id: 'EG-CA-01',
      severity: 'medium',
      status: 'open',
      detected_at: '2026-06-23T01:00:00Z',
      description: 'SSL certificate expired on edge proxy',
      affected_services: ['CDN'],
      affected_subscribers: 3000,
    },
  ],
  webhooks: [
    {
      ...
      events: ['outage.created', 'outage.resolved', 'sla.breached'],
      active: true,
      created_at: '2026-06-01T00:00:00Z',
    },
    {
  ...
  deliveries: [
    ...
    },
    {
      ...
      status: 'success',
      response_code: 200,
      created_at: '2026-06-21T08:46:00Z',
    },
    {
      id: 'del-12',
      webhook_id: 'wh-3',
