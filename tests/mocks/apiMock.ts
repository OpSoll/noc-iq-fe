...
export type ScenarioPack =
  'outages' | 'payments' | 'webhooks' | 'analytics' | 'empty';
    ...
    const base: Outage[] = [
      {
        ...
        description: 'Total upstream failure',
        affected_services: ['DNS', 'BGP'],
    ...
    return this.applyScenario([
      {
        ...
        outage_id: 'mock-1',
        status: 'open',
        reason: 'MTTR threshold disputed',
      ...
      },
      {
        ...
        outage_id: 'mock-2',
        status: 'resolved',
        reason: 'Resolved in favor of operator',
      ...
      },
      {
        ...
        resolved_at: '2026-06-21T16:00:00Z',
