...
- [ ] #429 Testing: Add Vitest unit tests for paymentService API response mappings
- [ ] #428 Testing: Add unit tests for outage resolution SLA calculations in outages service
- [ ] #427 Notifications: Add auto-dismiss countdown progress bar to Toast component
- [ ] #426 Performance: Memoize timeline node rendering and windowing in IncidentTimeline
- [ ] #425 Performance: Debounce search input updates in useOutageSearchAndLayout hook
- [ ] #424 Type Safety: Enforce strict TypeScript types for Axios API error envelopes
- [ ] #423 Shared: Replace plain text placeholders with centralized EmptyState component
- [ ] #422 Shared: Display global offline banner notification when backend server is unreachable
- [ ] #417 Navigation: Add reusable Breadcrumb navigation bar on sub-pages
- [ ] #416 Navigation: Set aria-current on active links and handle Escape key on mobile menu
- [ ] #415 Settings: Add one-click copy button with toast feedback for WalletAddress
- [ ] #414 Settings: Add client-side password strength meter for Register & Password forms
- [ ] #413 Dashboard: Add keyboard focus trap and ARIA labels to SLA SVG charts
- [ ] #412 Dashboard: Add quick-preset date range selector buttons in SLADashboardView
- [ ] #411 SLA Config: Add dirty form state confirmation before closing edit dialog
- [ ] #410 Outages: Add resolution preview step in ResolveOutageModal
...
- [x] #356 [FE-W6-021] Add ARIA live region announcements for async state changes
...
- [x] #352 [FE-W6-017] Add internationalization (i18n) infrastructure with locale switching
- [x] #351 [FE-W6-016] Implement real-time outage status updates via Server-Sent Events
- [x] #350 [FE-W6-015] Implement breadcrumb navigation component for nested routes
- [x] #349 [FE-W6-014] Add unit tests for all custom React hooks (useSession, useSlaConfig, etc.)
- [x] #348 [FE-W6-013] Add print-friendly CSS for outage reports and SLA summaries
- [x] #347 [FE-W6-012] Implement a global search command palette (Cmd+K) across outages and payments
- [x] #346 [FE-W6-011] Add focus management and keyboard navigation audit for modals/drawers
- [x] #345 [FE-W6-010] Implement optimistic UI updates for outage status changes
- [x] #344 [FE-W6-009] Add CSV/XLSX export for outages and payments tables
