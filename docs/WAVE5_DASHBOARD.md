...
- [ ] #527 State: Add theme preference persistence across browser tabs via StorageEvent listener
- [ ] #526 State: Add session timeout warning modal after 30 minutes of inactivity
- [ ] #525 State: Add active user role and permission guards in UI store
- [ ] #524 State: Add reactive online/offline network connection state listener
...
- [ ] #510 Webhooks: Add webhook delivery success rate latency chart
...
- [ ] #505 Disputes: Add dispute SLA credit adjustment preview modal
- [ ] #504 Disputes: Add dispute search by SLA Result ID or Outage ID
- [ ] #503 Disputes: Add dispute statistics summary KPI cards
- [ ] #502 Disputes: Add dispute notification email recipient tags
- [ ] #501 Disputes: Add export dispute audit log to PDF for legal compliance
- [ ] #500 Disputes: Add bulk dispute status resolution actions
...
- [x] #408 Outages: Render severity and status badges on Outage row cards
...
- [x] #404 Payments: Add date-range validation and clear-filters action button in PaymentsView
