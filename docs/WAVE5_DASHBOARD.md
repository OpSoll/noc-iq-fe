...
- [ ] #409 Outages: Add MTTR duration helper calculator in OutageDetailsPage
- [ ] #408 Outages: Render severity and status badges on Outage row cards
- [ ] #407 Outages: Add master Select All header checkbox with indeterminate state
- [ ] #406 Outages: Implement real batch delete and CSV export in OutagesPageClient
- [ ] #405 Payments: Enable column sorting for Amount and Status in Payments table
