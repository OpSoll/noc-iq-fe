...
export function ResolveOutageModal({
  ...
  const durationHint = hasDurationInput
    ? validateMttrMinutes(totalMinutes).error
    : null;
            ...
            <>
                ...
                <div className="grid gap-3 sm:grid-cols-2">
                  <div>
                    ...
                    <input
                      ...
                      value={hoursInput}
                      onChange={(event) =>
                        applyDurationParts(event.target.value, minutesInput)
                      }
                  ...
                  <div>
                    ...
                    <input
                      ...
                      value={minutesInput}
                      onChange={(event) =>
                        applyDurationParts(hoursInput, event.target.value)
                      }
                      className="w-full rounded-lg border border-slate-200 px-3 py-2 text-sm outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-100"
                      placeholder="0"
                    />
              ...
              <div>
                ...
                <input
                  ...
                  aria-describedby={
                    durationHint ? 'resolve-outage-mttr-hint' : undefined
                  }
                ...
                {durationHint ? (
                  ...
                  <p className="mt-2 text-xs text-slate-500">
                    Editing hours or minutes above updates this total
                    automatically.
                  </p>
                )}
              </div>
