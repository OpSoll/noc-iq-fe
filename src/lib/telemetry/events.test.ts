...
describe('event taxonomy', () => {
  ...
  describe('validateEvent', () => {
    ...
    it('rejects missing action', () => {
      expect(() =>
        validateEvent({ category: 'outage', timestamp: 1, route: '/' })
      ).toThrow("string 'action'");
    });
  ...
  describe('factory helpers', () => {
    it('creates outage event with defaults', () => {
      const e = createOutageEvent('resolve', '/outages/1', {
        outageId: '1',
        severity: 'high',
      });
    ...
    it('creates payment event', () => {
      const e = createPaymentEvent('refund', '/payments/2', {
        paymentId: '2',
        amount: 100,
      });
