...
const invalidationMap: InvalidationEntry[] = [
  {
    mutationType: 'outage.create',
    invalidate: [queryKeys.outages.all, queryKeys.dashboard.all],
  },
  {
    mutationType: 'outage.update',
    invalidate: [queryKeys.outages.all, queryKeys.dashboard.all],
  },
  {
    mutationType: 'outage.resolve',
    invalidate: [
      queryKeys.outages.all,
      queryKeys.dashboard.all,
      queryKeys.sla.config(),
    ],
  },
  {
    mutationType: 'outage.delete',
    invalidate: [queryKeys.outages.all, queryKeys.dashboard.all],
  },
  {
    mutationType: 'payment.process',
    invalidate: [queryKeys.payments.all, queryKeys.dashboard.all],
  },
  {
    mutationType: 'payment.refund',
    invalidate: [queryKeys.payments.all, queryKeys.dashboard.all],
  },
  {
    mutationType: 'payment.retry',
    invalidate: [queryKeys.payments.all, queryKeys.dashboard.all],
  },
  {
    mutationType: 'payment.reconcile',
    invalidate: [queryKeys.payments.all, queryKeys.dashboard.all],
  },
  ...
  {
    mutationType: 'sla.update',
    invalidate: [queryKeys.sla.config(), queryKeys.dashboard.all],
  },
...
export function getInvalidations(mutationType: string): QueryKeyPattern[] {
  return (
    invalidationMap.find((e) => e.mutationType === mutationType)?.invalidate ??
    []
  );
}
